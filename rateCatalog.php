...
<main class="main">
    ...
    <article style="margin-top: 1rem; text-align: center; border: 1px var(--pico-form-element-border-color) solid">
        ...
        $steamGames = (array)$client->send_request(['type' => RequestType::GET_GAMES_INFO, 'appids' => $games]);
        ?>
                ...
                <div style="max-height: 70vh; overflow-y: auto; padding-right: 1rem;">
                    <?php foreach ($steamGames as $game): ?>
                        ...
                        <div class="game-rating-div"
                             style="display: flex; align-items: center; padding: 1rem; margin-bottom: 0.4rem; border: 1px solid var(--pico-form-element-border-color); border-radius: 4px;">
                            <input type="hidden" name="names[<?= $appid ?>]" value="<?= $name ?>">
                            ...
                            <div style="flex: 1; text-align: left;">
                                ...
                                <div style="margin-top: 1rem;">
                                    <label for="rating-<?= $appid ?>"
                                           style="display: flex; align-items: center; gap: 1rem;">
                                        <span style="min-width: 80px; padding-bottom: 16px">Rating: <strong><span
                                                        id="value-<?= $appid ?>">5</span></strong></span>
                                        <input
                                                type="range"
                                                id="rating-<?= $appid ?>"
                                                name="ratings[<?= $appid ?>]"
